...
namespace Heelz
{
    ...
    public class HeelzPlugin : BaseUnityPlugin
    {
        ...
        private void Start()
        {
            ...
            Harmony.CreateAndPatchAll(typeof(HeelzPlugin));
        ...
        public static void OnChangeAnimation(HScene __instance, HScene.AnimationListInfo _info,
            bool _isForceResetCamera, bool _isForceLoopAction = false, bool _UseFade = true)
        {
        ...
        {
            return character == null ? null : character.gameObject.GetComponent<HeelsController>();
        }
    }
}
